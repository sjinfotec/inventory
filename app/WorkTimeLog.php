...
class WorkTimeLog extends Model
{
    ...
    public function getWorkinTimeLog($target_date){
        ...
        try {
            ...
            $sqlString .= "    ) as t3 ";
            $sqlString .= "    on ";
            $sqlString .= "      t3.account_id = t1.account_id ";
            ...
            $sqlString .= "    on ";
            $sqlString .= "      t4.account_id = t1.account_id ";
            $sqlString .= "      and t4.account_id = ? ";
            $sqlString .= "      and t4.date = ? ";
            ...
            $sqlString .= "    ) as t5 ";
            $sqlString .= "    on ";
            $sqlString .= "      t5.account_id = t1.account_id ";
            $sqlString .= "      and t5.code = t1.department_code ";
            $sqlString .= ") as t1 ";
            $sqlString .= "where ";
