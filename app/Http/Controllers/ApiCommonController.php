...
class ApiCommonController extends Controller
{
    ...
    public function getProcessView(Request $request){
        ...
        try {
            ...
            $sqlString .= "    WHEN '2' THEN '開始' ";
            $sqlString .= "    WHEN '3' THEN '中断' ";
            $sqlString .= "    WHEN '4' THEN 'ミス' ";
            $sqlString .= "    WHEN '5' THEN '完了' ";
            $sqlString .= "    WHEN '6' THEN '開始' ";
            $sqlString .= "    ELSE '' END as work_kind_name";
            $sqlString .= "  , CASE ifnull(t1.work_kind,'') ";
            $sqlString .= "    WHEN '1' THEN '' ";
            $sqlString .= "    WHEN '2' THEN '' ";
            $sqlString .= "    WHEN '3' THEN '' ";
            $sqlString .= "    WHEN '4' THEN '' ";
            $sqlString .= "    WHEN '5' THEN t1.process_time_h ";
            $sqlString .= "    WHEN '6' THEN t1.process_time_h ";
            ...
            $sqlString .= "    WHEN '3' THEN '' ";
            $sqlString .= "    WHEN '4' THEN '' ";
            $sqlString .= "    WHEN '5' THEN t1.process_time_m ";
            $sqlString .= "    WHEN '6' THEN t1.process_time_m ";
