...
Log::debug('lai = '.$login_account_id);
    ...
    public function putProcess(Request $request){
        ...
        try {
            ...
            $office_code_value = null;
            if (isset($params_product_process_data["office_code"])) {
            ...
            if ($result_exists) {
                ...
                foreach($details as $item) {
                    ...
                    if (!$result_exists) {
                        ...
                        $progress_header_model->setMaterialcustomernameAttribute(null);
    ...
    private function selectProcessView($params){
        ...
        try {
            ...
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.init')."' THEN '".Config::get('const.WORKKINDS_NAME.init')."' ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.start')."' THEN '".Config::get('const.WORKKINDS_NAME.start')."' ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.stop')."' THEN '".Config::get('const.WORKKINDS_NAME.stop')."' ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.miss')."' THEN '".Config::get('const.WORKKINDS_NAME.miss')."' ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.complete')."' THEN '".Config::get('const.WORKKINDS_NAME.complete')."' ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.next')."' THEN '".Config::get('const.WORKKINDS_NAME.next')."' ";
            $sqlString .= "    ELSE '' END as work_kind_name";
            $sqlString .= "  , CASE ifnull(t1.work_kind,'') ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.init')."' THEN '' ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.start')."' THEN '' ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.stop')."' THEN '' ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.miss')."' THEN '' ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.complete')."' THEN t1.process_time_h ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.next')."' THEN '' ";
            ...
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.stop')."' THEN '' ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.miss')."' THEN '' ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.complete')."' THEN t1.process_time_m ";
            $sqlString .= "    WHEN '".Config::get('const.WORKKINDS.next')."' THEN '' ";
