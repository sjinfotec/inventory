                            ...
                            @if($menu_selections[Config::get('const.MENUITEM.setting_block') - 1]->is_select)
                                ...
                                <ul class="collapse show list-unstyled" id="collapseSetting">
                                    @if($menu_selections[Config::get('const.MENUITEM.setting_product') - 1]->is_select)
                                        <!--<li><a class="px-3 py-1 text-white d-block" href="{{ url('/create_') }}"><img class="icon-size-sm mr-3" src="{{ asset('images/round-business-w.svg') }}" alt="">{{ $menu_selections[Config::get('const.MENUITEM.setting_product') - 1]->item_kanji_name }}</a></li>-->
                                    @endif
                                    ...
                                    @if($menu_selections[Config::get('const.MENUITEM.setting_office') - 1]->is_select)
                                        <li><a class="px-3 py-1 text-white d-block" href="{{ url('/create_office') }}"><img class="icon-size-sm mr-3" src="{{ asset('images/round-restore-w.svg') }}" alt="">{{ $menu_selections[Config::get('const.MENUITEM.setting_office') - 1]->item_kanji_name }}</a></li>
                                    @endif
