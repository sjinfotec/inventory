                    ...
                    <div class="col-xl-2 px-0 offcanvas-collapse offcanvas-collapse-from-left side-base">
                        <nav class="text-white">
                            ...
                            <ul class="collapse show list-unstyled" id="collapseSetting">
                                ...
                                <li><a class="px-3 py-1 text-white d-block" href="{{ url('/setting_calc') }}"><img class="icon-size-sm mr-3" src="{{ asset('images/round-laptop-chromebook-w.svg') }}" alt="">基本設定</a></li>
