 ...
 */
 ...
 Vue.component(
     "edit-work-order",
     require("./components/EditWorkOrder.vue").default
 );
 
 // 指示書／管理書（ホーム）
 Vue.component(
     "table-progress-header",
     require("./components/TableProgressHeader.vue").default
 );
 ...
 Vue.component(
     "select-officelist",
     require("./components/SelectOfficeList.vue").default
 );
 Vue.component(
     "select-customerlist",
...
Vue.component(
 ...
 Vue.component(
     "select-devicelist",
     require("./components/SelectDeviceList.vue").default
 );
