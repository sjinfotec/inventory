...
export default {
  ...
  mounted() {
    ...
    console.log('this.login_generaluser_role' + this.login_generaluser_role);
    ...
    console.log('this.login_generalapproveruser_role' + this.login_generalapproveruser_role);
    console.log('this.adminuser' + this.adminuser);
    this.login_adminuser_role = this.adminuser;
    console.log('this.login_adminuser_role' + this.login_adminuser_role);
