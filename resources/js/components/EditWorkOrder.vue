      ...
      <div class="col-md pt-3">
        <div class="card shadow-pl">
          ...
          <div class="card-body pt-2" v-if="isQr">
            ...
            <div class="row justify-content-between">
              <!-- .col -->
              <div class="col-md-6 pb-2 print-none">
                <div class="input-group">
                  <div class="input-group-prepend">
                    <label
                      class="input-group-text font-size-sm line-height-xs label-width-120"
            ...
            <div class="row justify-content-between">
              ...
              <div class="col-3 pb-2">
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span
                      class="input-group-text font-size-sm line-height-xs label-width-80"
                      id="basic-addon1"
                    >明細摘要</span>
                  </div>
                  <div class="form-control p-0">
            ...
            <div class="row justify-content-between">
              ...
              <!-- /.col -->
              <!-- .col -->
              <div class="col-md-3 pb-2 print-none">
                <div class="input-group">
                  <div class="input-group-prepend">
                    <label
                      class="input-group-text font-size-sm line-height-xs label-width-80"
                  ...
                  <select-officelist
                    ref="selectmaterialofficelist"
                    v-if="showoMaterialofficelist"
                    v-bind:blank-data="true"
                    v-bind:placeholder-data="'納入元の営業所を選択してください'"
                    v-bind:selected-value="selectedMaterialOfficeValue"
                    v-bind:add-new="false"
                    v-bind:row-index="0"
                    v-on:change-event="materialofficeChanges"
                  ></select-officelist>
                </div>
                <message-data
                  v-bind:message-datas="messagedataomaterialffice"
                  v-bind:message-class="'warning'"
                ></message-data>
              </div>
              <!-- /.col -->
              ...
              <div class="col-md-3 pb-2">
                <div class="input-group">
                  ...
                  <select-customerlist
                    ref="selectmaterialcustomerlist"
                    v-if="showoMaterialcustomerlist"
                    v-bind:blank-data="true"
                    v-bind:placeholder-data="'納入元を選択してください'"
                    v-bind:selected-value="selectedMaterialCustomerValue"
                    v-bind:add-new="false"
                    v-bind:office-code="selectedMaterialOfficeValue"
                    v-bind:row-index="0"
                    v-on:change-event="materialcustomerChanges"
                  ></select-customerlist>
                </div>
                <message-data
            ...
            <div class="row justify-content-between">
              ...
              <div class="col-md-6 pb-2 print-none">
                <div class="input-group">
                  ...
                  <select-officelist
                    ref="selectOutsourcingofficelist"
                    v-if="showoOutsourcingofficelist"
                    v-bind:blank-data="true"
                    v-bind:placeholder-data="'外注先の営業所を選択してください'"
                    v-bind:selected-value="selectedOutsourcingOfficeValue"
                    v-bind:add-new="false"
                    v-bind:row-index="0"
                    v-on:change-event="outsourcingofficecodeChanges"
                  ></select-officelist>
                </div>
                <message-data
                  v-bind:message-datas="messagedataooutsourcingffice"
                  v-bind:message-class="'warning'"
                ></message-data>
              </div>
              <!-- /.col -->
                ...
                <div class="table-responsive">
                  <div class="col-12 p-0">
                    <table class="table table-striped border-bottom font-size-sm text-nowrap">
                      <thead>
                        <tr>
                          <td class="text-center align-middle w-5">工程No.</td>
                          ...
                          <span>使用機種</span></td>
                          <td class="text-center align-middle w-15">機器名</span></td>
                          <td class="text-center align-middle w-15">加工者</span></td>
                          <td  colspan="4" class="text-center align-middle w-5">加工時間</span></td>
                          <td  colspan="4" class="text-center align-middle w-5">段取り</span></td>
                          <td class="text-center align-middle w-5 print-none">完了日</span></td>
                          <!-- <td class="text-center align-middle w-5">QRコード</td> -->
                        </tr>
                      </thead>
                      <tbody>
                        <tr v-for="(n,index) in 12" :key="index">
                          <td class="text-center align-middle">{{form.progress_no[index]}}</td>
                          ...
                          <td class="text-left align-middle mw-rem-2">H</td>
                          <td class="text-center align-middle mw-rem-5">
                            <div class>
                              <input
                                type="number"
                          ...
                          <td class="text-left align-middle mw-rem-2">M</td>
                          <td class="text-center align-middle mw-rem-5">
                            <div class>
                              <input
                                type="number"
                          ...
                          <td class="text-left align-middle mw-rem-2">M</td>
                          <td class="text-center align-middle print-none">
                            <div class>
                              <input
                                type="date"
                                class="form-control"
