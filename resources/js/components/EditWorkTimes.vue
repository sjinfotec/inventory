        ...
        <div class="card-body pt-2">
          ...
          <div class="row justify-content-between">
            ...
            <div class="col-md-6 pb-2">
              <div class="input-group">
                <div class="input-group-prepend">
                  <label class="input-group-text font-size-sm line-height-xs label-width-90" for="inputGroupSelect01">氏名</label>
                </div>
          ...
          <div class="row justify-content-between">
            ...
            <div class="col-md-12 pb-2">
              <div class="btn-group d-flex">
                <button class="btn btn-primary btn-lg font-size-rg w-100" @click="getDetail()"><img class="icon-size-sm mr-2 pb-1" src="/images/round-search-w.svg" alt="">この条件で表示する</button>
              </div>
            </div>
            <!-- /.col -->
            <!-- col -->
            <div class="col-md-12 pb-2" v-if="valueuser != ''">
              <div class="btn-group d-flex">
                <button class="btn btn-success btn-lg font-size-rg w-100" v-on:click="show"><img class="icon-size-sm mr-2 pb-1" src="/images/round-search-w.svg" alt="">勤務時間を追加</button>
              </div>
            </div>
            <!-- /.col -->
          </div>
      ...
      <div class="card shadow-pl">
        ...
        <div class="card-body mb-3 p-0 border-top">
                    ...
                    <tbody>
                      <tr v-for="(item,index) in details" v-bind:key="item.id">
                        ...
                        <td class="text-center align-middle" v-if="index==0">
                          <div class="input-group">
                            <div class="input-group-prepend">
                              <label class="input-group-text font-size-sm line-height-xs label-width-90" for="inputGroupSelect01">休暇区分</label>
                            </div>
                        ...
                        <td class="text-center align-middle">
                          <div class="btn-group d-flex">
                            <button type="button" class="btn btn-danger btn-lg font-size-rg w-100" @click="alertDelConf('warning',item.id)">削除</button>
                          </div>
                        </td>
                      </tr>
                    </tbody>
          ...
          <div class="row justify-content-between px-3">
            ...
            <div class="col-md-12 pb-2">
              <div class="btn-group d-flex">
                <button type="button" class="btn btn-success btn-lg font-size-rg w-100" @click="alertStoreConf('info')">この内容で編集を確定する</button>
              </div>
            </div>
            <!-- /.col -->
          </div>
