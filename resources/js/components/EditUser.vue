      ...
      <div class="col-md pt-3">
        <div class="card shadow-pl">
          ...
          <daily-working-information-panel-header
            v-bind:header-text1="'ユーザー登録および編集'"
            v-bind:header-text2="'ユーザーを選択すると登録済みのユーザー情報を編集できます'"
          ></daily-working-information-panel-header>
          <!-- /.panel header -->
          <!-- panel contents -->
              ...
              <div class="col-md-6 pb-2">
                <div class="input-group">
                  ...
                  <select-employmentstatus
                    v-bind:blank-data="true"
                    v-bind:selectedEmploymentStatus="form.status"
              ...
              <div class="col-md-6 pb-2">
                <div class="input-group">
                  ...
                  <select-department
                    ...
                    v-bind:selected-department="form.departmentCode"
              ...
              <div class="col-md-6 pb-2">
                <div class="input-group">
                  ...
                  <general-list
                    ...
                    v-bind:selectedValue="form.management"
              ...
              <div class="col-md-6 pb-2">
                <div class="input-group">
                  ...
                  <general-list
                    ...
                    v-bind:placeholder-data="'勤怠管理の有無を選択してください'"
                    v-bind:blank-data="false"
                    v-bind:selectedValue="form.role"
                    v-on:change-event="displayChange"
                  ></general-list>
                </div>
              </div>
          ...
          <div class="card-body pt-2">
            ...
            >
              ...
              <div class="row justify-content-between">
                ...
                <!-- /.col -->
                <!-- .col -->
                <!-- <div class="col-md-6 pb-2" v-if="valueuser=='' || valueuser==null ">
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span
                        class="input-group-text font-size-sm line-height-xs label-width-150"
            ...
            <div class="row justify-content-between" v-if="userDetails.length">
              ...
              <div class="col-md-12 pb-2">
                <div class="btn-group d-flex">
                  <button class="btn btn-success" @click="FixUser()" v-if="valueuser != ''">修正する</button>
                </div>
              </div>
              <!-- /.col -->
            </div>
...
export default {
  ...
  methods: {
    ...
    // 部署選択が変更された場合の処理（登録時）
    adddepartmentChanges: function(value) {
      this.form.departmentCode = value;
    },
    // 雇用形態が変更された場合の処理（登録時）
    addemploymentChanges: function(value) {
    ...
    getUserSelected: function() {
      if (this.valuedepartment == "") {
        this.$refs.selectuser.getUserList(
          this.getDo,
          this.valueuser,
          this.fromdate
        );
