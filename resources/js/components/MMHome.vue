<template>
  <div>
      <div id="tips_cnt">
          ...
          <li>在庫を更新編集する準備
            <ol class="lst2">
            <li>メニュー欄より『在庫』をクリック、『部署』をクリック、一覧を表示させる</li>
          ...
          <li>在庫の修正
            ...
            <li>『この内容に修正する』をクリックすることで表示されている内容で上書き保存できます</li>
          ...
          <li>新たに商品を登録するには
            ...
            <li>『この内容で新規登録する』をクリックすると商品が新しい管理で登録されます</li>
            </ol>
          </li>
          </ul>
      </div>
