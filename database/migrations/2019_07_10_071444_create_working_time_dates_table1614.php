...
class CreateWorkingTimeDatesTable1614 extends Migration
{
    ...
    public function up()
    {
        Schema::create('working_time_dates', function (Blueprint $table) {
            ...
            $table->String('department_name')->comment('部署名称');
            ...
            $table->time('missing_middle_time')->nullable()->comment('中抜時刻');
            $table->time('missing_middle_return_time')->nullable()->comment('中抜戻り時刻');
