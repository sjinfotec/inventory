...
return [
    ...
    'ALERT_MONTHLY_ITEM' => [
        'items_1' => '<法定：月上限残業45時間>',
        'items_2' => '<法定：2か月上限残業81時間>',
        'items_3' => '<法定：3か月上限残業120時間>',
        'items_4' => '<法定：年上限残業360時間>',
        'items_5' => '<法定：年間45時間超月数6以内>',
        'items_6' => '<法定：月100時間未満>',
        'items_7' => '<法定：2か月平均80時間>',
        'items_8' => '<法定：3か月平均80時間>',
        'items_9' => '<法定：4か月平均80時間>',
        'items_10' => '<法定：5か月平均80時間>',
        'items_11' => '<法定：6か月平均80時間>',
        'items_12' => '<法定：年上限残業720時間>'
    ],
